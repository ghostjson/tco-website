    ...
    <Layout>
      ...
      >
        <img
          ...
          alt='main-logo'
          className='mt-14 mx-auto md:mt-16 h-8 md:h-10  md:ml-20'
        />
        <img
      ...
      <div className='mt-[45vh] flex flex-col items-center p-16 px-16'>
        <span className='relative py-2'>
          <h2 className='text-4xl uppercase font-semibold text-[#3A7A98]'>
            Marketing Design
          </h2>
          <div className='absolute h-0.5 w-1/4 bottom-0 bg-[#3A7A98] left-1/2 transform -translate-x-1/2 rounded-full'></div>
        </span>
        <p className='text-xl text-center mt-2 text-[#3A7A98]'>
          We create marketing materials that communicates effectively to your
          target audiences in order to boost sales.
        </p>
        <div className='flex w-full justify-evenly items-start mt-16 px-32'>
          <PriceChart
            color='#3A7B99'
            price='50'
      ...
      >
        ...
        <div className='uppercase text-2xl -mt-2'>From $750</div>
        <p className='text-lg md:text-xl tracking-wide mt-6 w-10/12'>
        ...
        <p className='mt-6 text-xl'>Contact us for more information.</p>
      </div>
    </Layout>
  );
};
